...
public class MainMemory extends AbstractMainMemory {
  ...
  //  return ((byteAtAddrPlus0 & 0xff) << 24) | ((byteAtAddrPlus1 & 0xff) << 16) | ((byteAtAddrPlus2 & 0xff) << 8) | (byteAtAddrPlus3 & 0xff);
      int firstByte = byteAtAddrPlus0 & 0xff;
      int secondByte = byteAtAddrPlus1 & 0xff;
      int thirdByte = byteAtAddrPlus2 & 0xff;
      int fourthByte = byteAtAddrPlus3 & 0xff;
  ...
  @Override public byte[] integerToBytes (int i) {
      byte[] bigEndianByte = new byte[4];
      bigEndianByte[0] = (byte) (i >> 24);
      bigEndianByte[1] = (byte) (i >> 16);
      bigEndianByte[2] = (byte) (i >> 8);
      bigEndianByte[3] = (byte) (i);
      return bigEndianByte;
  }
