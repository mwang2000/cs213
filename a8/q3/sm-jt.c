...
int exec() {
  ...
  void* jumptable[16] = {&&J0,&&J1,&&J2,&&J3,&&J4,&&J5,&&J6,&&J7,&&DEFAULT2,&&DEFAULT2,&&DEFAULT2,&&DEFAULT2,&&DEFAULT2,
  &&DEFAULT2,&&DEFAULT2,&&J15};
...
L4: addr = reg [insOp1] + (reg [insOp2] << 2);
    ...
    mem [addr+3] = val       & 0xff;
    goto CONT;
L6: if (insOp0 < 0 || insOp0 > 15) goto DEFAULT2;
    goto *jumptable[insOp0];

    J0: reg [insOp2] = reg [insOp1];
        goto CONT;
    J1: reg [insOp2] = reg [insOp1] + reg [insOp2];
        goto CONT;
    J2: reg [insOp2] = reg [insOp1] & reg [insOp2];
        goto CONT;
    J3: reg [insOp2] = reg [insOp2] + 1;
        goto CONT;
    J4: reg [insOp2] = reg [insOp2] + 4;
        goto CONT;
    J5: reg [insOp2] = reg [insOp2] - 1;
        goto CONT;
    J6: reg [insOp2] = reg [insOp2] -4;
        goto CONT;
    J7: reg [insOp2] = ~ reg [insOp2];
        goto CONT;
    J15:reg [insOp2] = pc + (insOp1 << 1);
        goto CONT;
...
L11:pc = insOpExt;
    goto CONT;
L12:pc = (((unsigned short) insOpImm) << 1) + reg [insOp0];
    goto CONT;
L15: if (insOp0 == 0)
          cont = 0;
        else if (insOp0 == 1) {
